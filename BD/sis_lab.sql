...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2021 a las 23:49:23
...
(1, 2580, 'SISLAB', 'Examenes de Laboratorio', 925491523, 'sis@lab.com', 'Zulia - Venezuela ', '1.18');
...
(1, 'Hematologia', 1, '5.00', 49, 2),
(2, 'Orina', 1, '3.00', 20, 1),
(6, 'Colesterol', 1, '3.00', 0, 1),
(7, 'Embarazo', 3, '15.00', 5, 1);
...
(1, 'Samuel Figueroa', 'admin@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(6, 'Maria Perez Miranda', 'maria@gmail.com', 'maria', '263bce650e68ab4e23f28263760b9fa5', 3),
(9, 'Empleado uno', 'emple@gmail.com', 'empleado', '088ef99bff55c67dc863f83980a66a9b', 2);
